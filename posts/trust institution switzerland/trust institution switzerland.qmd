...
This last graph is the one I am the most satisfied with: the time frame is large enough, the variable is the same for each year and the results are far more contrasted and interesting than the previous graphs. One can see clearly different periods of declining and increasing confidence in governments, which leads to the conclusion that Switzerland knew different waves of decreasing and increasing political stability as well as clear periods of political crisis. For instance, the graph illustrates well the political crisis of the 1980s: the percentage of people having confidence in government fell from 65% in 1998 to 38.9% in 1995.
