...
# [NLCN] Civilian labour force (Labour force statistics), annually, 1000 persons

L <- rdb(ids = "AMECO/NLCN/CHE.1.0.0.0.NLCN") %>% 
  filter(original_period %in% c(1960:2022)) %>% 
  select(value) %>% 
  ts(start = 1960, end = 2022)
