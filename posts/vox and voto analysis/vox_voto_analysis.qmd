...
```
The differences in probability have slighlty change, but the conclusions here are in fine the same as the no-control regression.
...
comparisons_plot_glmer(comparison_glmer_svp)+
  labs(title = "Differences in Probability: Support for SVP",
       subtitle = "Partial Pooling (glmer) logit model",
       caption = "Difference between highest and lowest income groups (income) and
       between university graduates and trainees (educ))")
```
