...
datareg <- panel2019 %>% dplyr::select("vote.left", "Education.level", "Gross.monthly.hh.income", "religion", "gender", "W1_f10000", "W1_f20900", "W1_age", "W1_f10250", "W1_3_smt9", "W1_3_canton_sample", "W1_agecat")
...
avg_slopes(reg3, variables = c("Gross.monthly.hh.income"), by = "Education.level")
margins(reg3)
reg3effect %>% 
  group_by(term) %>% 
  summarise(avg_marginal_effect = mean(estimate)) %>% 
  ungroup()
```
