...
#selects2023panel <- haven::read_sav("~/GitHub/celalguney/posts/assurance_maladie/data/selects2023panel/selects2023panel.sav") # windows

selects2023panel <- read_sav("Documents/GitHub/celalguney/posts/assurance_maladie/data/selects2023panel/selects2023panel.sav") #linux
...
summary(model2 <- polr(data = selects2023panel2,
           assurance_maladie_franchise_pour ~ eseg10 + income_adj_decile + education_ISCED + canton,
           Hess = TRUE), method = "logit")
...
p2 = avg_predictions(model2, by = "income_adj_decile")
...
p2 %>% 
  ggplot(aes(x = income_adj_decile, y = estimate, color = group))+
  geom_line()+
