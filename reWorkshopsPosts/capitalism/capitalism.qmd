...
![](images/Planning d'Octobre 2024 3ème version.png){fig-align="center"}
...
## Grasping real-world capitalisms {.smaller}

> > "Orthodox Marxism remained fixated for a long time on the formulation of the fundamental social relations of capitalism (private ownership of the means of production, commodities and money, the legal constitution of the "free bearer of labor power") without seeing, precisely, that these relations were… fundamental. That is to say, "incomplete," under-determined. The fundamental social relations of capitalism are never observed as they are, so to speak, in their "fundamentality." They are only observed as historically actualized, in a certain way" ([Lordon 2021](https://journals.openedition.org/asterion/6049))
